...
console.log(jon.hasDriverLicense ? `a` : `no`);
console.log(`${jon.firstName} is a ${jon.age} year old ${jon.job}, and he has ${jon.check()} driver's license`);
...
const types = [];
//Reading from jonarray
for (let i = 0; i < jonArray.length; i++) {
    console.log(jonArray[i], typeof jonArray[i]);

    //Filling types array
    // types[i] = typeof jonArray[i];
    types.push(typeof jonArray[i]);
}
console.log(types);
...
for (let i = 0; i < jonArray.length; i++) {
    if (typeof jonArray[i] !== `string`) continue;
    console.log(jonArray[i], typeof jonArray[i]);
}
console.log(`---BREAK WITH NUMBER---`);
for (let i = 0; i < jonArray.length; i++) {
    if (typeof jonArray[i] === `number`) break;
    console.log(jonArray[i], typeof jonArray[i]);
}
